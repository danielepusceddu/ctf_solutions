...
struct Student {
    char name[NAME_SIZE];
    void (*scoreProfessor)(struct Professor*, int); //I need to modify this?
};

//Modifies lastScore of a given professor..
...
/* HOW TO EXPLOIT
 * 1) Create professor
 * 2) Give him the win function address as score
 * 3) Then, use the professor as a student to rate another professor.*/
int main (int argc, char **argv)
{
    while(ADRESSES_TAKEN<MAX_ADDRESSES-1){ //MAX_ADDRESSES = 1000
        //Create student
        ...
        student->scoreProfessor=&giveScoreToProfessor; //Assigns function to function pointer...
        ADRESSES_TAKEN+=2;
